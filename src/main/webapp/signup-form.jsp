...
<div class="signup-form">
    <form action="signup" method="post">
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-primary btn-lg"><a href="signup-success.jsp"> Sign Up</a></button>
        </div>
    </form>
    <div class="hint-text">Already have an account? <a href="login-form.jsp">Login here</a></div>
</div>
</body>
</html>