            ...
            <div class="row">
                        ...
                        <div class="limit-box">
                            <nav class="main-menu">
                                <ul class="menu-area-main">
                                    ...
                                    <li> <a href="signup-form.jsp">Sign Up</a> </li>
                ...
                <div class="col-md-6 offset-md-6">
                    <div class="location_icon_bottum">
                        <ul>
                            <li><img src="icon/call.png" />(+234)876543109</li>
                            <li><img src="icon/email.png" />Rose@gmail.com</li>
                            <li><img src="icon/loc.png" />Benin City</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption relative">
                        ...
                        <p>"Step into the World of Innovation and Convenience at Gadget Villa,<br>
                            Your Ultimate Destination for Cutting-Edge Technology.<br>
                            Explore a Myriad of Features Designed to Elevate Your<br>
                            Mobile Experience and Make Every Interaction Effortlessly Seamless. <br>
                            Welcome Home to Gadget Villa, Where Innovation Meets Convenience and<br>
                            Every Feature Feels Like a Familiar Comfort."
                        ...
                        <a class="buynow" href="product_page.jsp">Buy Now</a>
            ...
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption relative">
                        <span>All New Phones </span>
                        <h1>up to 25% Flat Sale</h1>
                       <p> Mobile Experience and Make Every Interaction Effortlessly Seamless. <br>
                        Welcome Home to Gadget Villa, Where Innovation Meets Convenience and<br>
                        Every Feature Feels Like a Familiar Comfort."</p>
